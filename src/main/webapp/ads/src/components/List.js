...
export default function List({title, name, data, selected, chooseElement, input, doSearch}){
    ...
    <div className="card h-100 border rounded-0 border-dark">
        ...
        <input value={input} onChange={doSearch} type="text" className="form-control shadow-none rounded-0 border-dark w-95" placeholder={"Enter " + name.toLowerCase()  +" name"}/>
